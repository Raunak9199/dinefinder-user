...
Future openAppDialog({required OpenDialogModel params}) {
  final shape =
                ...
                ? <Widget>[
                    OutlinedButton(
                      style: OutlinedButton.styleFrom(
                        side:
                            const BorderSide(color: AppColor.secondaryEmphasis),
                      ),
                      onPressed: params.onCancel ?? Nav.pop,
                      child: Text(
                        params.cancelText != null
                            ? params.cancelText!.toUpperCase()
                            : "aut_noStr".tr.toUpperCase(),
